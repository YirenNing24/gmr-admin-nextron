...
import { createIndex } from '../../renderer/server/search';


const Transition = forwardRef(function Transition(props, ref) {
  return <Slide direction="up" ref={ref} {...props} />;
});
const AddIndex = ({ isOpen, onClose }) => {
    // ** States
    ...
    const onSubmit = async (data) => {
        setIsUploading(true)
        const { indexName, primaryKey } = data
        await createIndex( indexName, primaryKey)
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            ...
            <TextField sx={{marginBottom: '10px'}} fullWidth label='Primary key'  placeholder='primary key'
        ...
        <DialogActions>
          ...
          <Button variant='contained' onClick={handleSubmit(onSubmit)} disabled={isUploading}>
